...
recommendation_bp = Blueprint("recomendation", __name__, template_folder="templates", static_folder="static")
...
def get_similar_courses(query):
    """Function to get similar courses based on the user's query"""
    if df.empty:
...
def show_courses():
    """Handle the search query and return similar courses"""
